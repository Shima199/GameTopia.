...
| ------------- | ------------- | ------------- |
| Hamza Abdulghani |  ●	Page: Gaming Platforms ●	Web elements: Navigation buttons for the 3 consoles.   |F●	Elaborate more about the new Generation consoles. ●	Add more media. |
